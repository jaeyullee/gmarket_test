...
3scale Operator의 APIManager에 apicast image를 지정 할 경우, ImageStream의 참조 이미지가 자동으로 변경됩니다.<br>
...
> catalogsource name이 image name를 참조하기 때문에, image name 첫글자가 숫자면 catalogsource 생성이 불가능합니다.<br>
> 필요 시 변경합니다.
